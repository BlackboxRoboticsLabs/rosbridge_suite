# Blackbox readiness adapter for RobotWebTools/rosbridge_suite

This fork contains a small Blackbox Robotics compatibility capsule for robot telemetry bridge for web review.
